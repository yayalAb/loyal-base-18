...
class SuppliesPortal(CustomerPortal):
    ...
    def supplies_portal_rfq(self, page=1, sortby=None, search=None, search_in=None, groupby=None, **kw):
        ...
        return request.render(
            'VendorBid.portal_supplies_rfq_tree_view',
            {
                'rfqs': rfqs,
                'page_name': 'rfq_list',
                'pager': pager,
    ...
    def supplies_portal_rfq_view(self, rfq_ref, **kw):
        ...
        return request.render(
            'VendorBid.portal_supplies_rfq_form_view',
            {
                'rfq': rfq,
    ...
    def portal_partner_profile(self, **kwargs):
        ...
        return request.render('VendorBid.portal_partner_profile_view', {
            'partner': partner,
    ...
    def supplier_portal_request_for_bid(self, category_id=None, **kw):
        ...
        return request.render('VendorBid.portal_request_rfp_form', {
    ...
    def category_prods_html(self, **kwargs):
        ...
        html = utils.render_qweb_template(
            request.env,
            "VendorBid.portal_product_select_options",
    ...
    def submit_rfp_form(self, **post):
        ...
        try:
            ...
            for reviewer in reviewers:
                template = request.env.ref('VendorBid.email_template_requester_submit_rfp').sudo()
    ...
    def register_requester(self, **post):
        ...
        if request.httprequest.method == 'POST':
            ...
            for reviewer in reviewers:
                template = request.env.ref('VendorBid.email_template_requester_registration').sudo()
                template.with_context(**contexts).send_mail(reviewer.id, email_values=email_values)
        ...
        return request.render('VendorBid.portal_supplies_requester_registration_form_view', {
    ...
    def portal_partner_profile_edit(self, **kwargs):
        ...
        if http.request.httprequest.method == 'GET':
            return http.request.render('VendorBid.portal_partner_profile_edit', {
                'partner': partner,
                'error': {},
                'values': partner_data,
            ...
            for reviewer in reviewers:
                template = request.env.ref('VendorBid.email_template_partner_edit_request').sudo()
                template.with_context(**contexts).send_mail(reviewer.id, email_values=email_values)
