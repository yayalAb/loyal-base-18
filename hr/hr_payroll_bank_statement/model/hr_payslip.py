...
class PayslipWithCustomColumns(models.Model):
    ...
    core_department = fields.Char(
        string="Core Department", related="department_id.cost_center", store=True, readonly=True)
    ...
    def _calculate_all_rule_amounts(self):
        target_rule_codes = [
            'ATTACH_SALARY', 'ASSIG_SALARY', 'CHILD_SUPPORT', 'DEDUCTION', 'PENSION', 'INTAX', 'REIMBURSEMENT', 'SOCC', 'OT100', 'LO', "TAXSAL", 'LUNCHDED', "OTHDED",
