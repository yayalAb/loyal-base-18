...
################################################################################
{
    ...
    "assets": {
        ...
        "web.assets_backend": [
            ...
            'base_hospital_management/static/src/js/autocomplete_widget.js',
            'base_hospital_management/static/src/xml/autocomplete_widget.xml',
            'base_hospital_management/static/src/css/autocomplete_widget.css',
        ],
    },
